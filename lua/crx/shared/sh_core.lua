...
function CRX:GetCommand(cmd)
	if !string.IsValid(cmd) then return end
end

function CRX:GetCommands()
...
function CRX:DoCommand(ply, cmd, args, argstring)
...
function CRX:GetCategories()
	return self.Categories
end

function CRX:AddCategory(category)
...
function CRX:RemoveCategory(category)
	table.insert(self.Categories, category)
